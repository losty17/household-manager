    ...
    <div className="p-4 space-y-4 pb-24">
        ...
        <Card className="bg-green-50 border-green-200">
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-green-600">Comprar</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      {lowStockItems.length > 0 && (
        <Card>
          <CardHeader className="pb-2 pt-4 px-4">
            <CardTitle className="text-base flex items-center gap-2">
              <TrendingDown className="h-4 w-4 text-yellow-500" /> Níveis de Estoque
            </CardTitle>
          </CardHeader>
      ...
      {products.length === 0 && (
        <Card className="text-center py-12">
          <CardContent>
            ...
            <p className="text-muted-foreground mb-4">Nenhum item ainda. Comece adicionando produtos ao inventário.</p>
            <Link to="/inventory">
